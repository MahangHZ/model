...
class Parameters:
    ...
    # 以下为emission参数：
    factor_cox_ice = 0.543  # kg/kWh (来自曾艾东)
    factor_cox_boiler = 0.254  # kg/kWh
    factor_cox_absorption_chiller = 0.171  # kg/kWh
    factor_cox_grid = 0.922  # kg/kWh
    factor_nox_ice = 0.00015  # kg/kWh
    factor_nox_boiler = 0.00054  # kg/kWh
    factor_nox_absorption_chiller = 0.00006  # kg/kWh
    factor_nox_grid = 0.002295  # kg/kWh
    factor_sox_ice = 0.0000032  # kg/kWh
    factor_sox_boiler = 0.000764  # kg/kWh
    factor_sox_absorption_chiller = 0.0000008  # kg/kWh
    factor_sox_grid = 0.003583  # kg/kWh
