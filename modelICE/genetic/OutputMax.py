...
from cn.modelICE.genetic.objectfunction.ObjectiveFunction import ObjectiveFunctionICE
...
class OutputMaxICE:
    def __init__(self, translation_result, number, season, mode):
        ...
        for i in range(Constant.population_size):
            ...
            objective_function_ice = ObjectiveFunctionICE(temporary, number, season, mode)
